...
namespace WebSearch.Function
{
    public class Suggest
    {
            ...
            FunctionContext executionContext)
        {
            ...
            var suggesterResponse = await searchClient.SuggestAsync<VacancyModel>(data.SearchText, data.SuggesterName, options);
            
            // Data to return
            var searchSuggestions = new Dictionary<string, List<SearchSuggestion<VacancyModel>>>
            {
